...
<body>
    ...
    <div id="colorswath">
        ...
        <table id="table2" style="width: 80%; margin:10px auto">
            <?php
                for($row = 0; $row < $input2; $row++){
                    echo "<tr id=\"squareTable\">";
                    for($col = 0; $col < $input2; $col++){
                        $asciiValue = 65 + $col;
                        $letterValue = chr($asciiValue);
                        echo "<td id=\"table2td\">
                                <form method=\"post\">
                                    <input type=\"submit\" data-col=\"$col\" data-row=\"$row\" class= \"button\" id = \"table2button\" value=\"$letterValue$row\">
                            </td>";
                    }
                    echo "</tr>";
                }
        ...
        <button id="ntButton">Print Preview</button>
    </div>
    <script>
